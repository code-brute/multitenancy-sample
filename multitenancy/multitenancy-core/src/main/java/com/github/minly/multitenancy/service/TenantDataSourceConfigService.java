package com.github.minly.multitenancy.service;
...
import com.github.minly.multitenancy.repository.TenantDataSourceConfigRepository;
...
public class TenantDataSourceConfigService implements InitializingBean {
	...
	@Transactional
	public TenantDataSourceConfigEntity createTenantDataSource(String db_name, String driver_class_name, String tenant_id, String password, String server_name, String port, String url) {
	...
	public TenantDataSourceConfigEntity getTenantDatasourceConfig(String tenantId) {
		try {
			TenantDataSourceConfigEntity tenantDsConfig = streamProvider.streamAll(em, TenantDataSourceConfigEntity.class).where(entity -> tenantId.equals(entity.getTenantId())).getOnlyValue();
